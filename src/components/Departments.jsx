...
const departments = [
  ...
  },
  {
    ...
    description: "Welcomes members warmly and ensures order during services.",
  },
  {
...
const Departments = () => {
  ...
  return (
    <section className="py-16 bg-[#f9fff9] relative">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="relative">
          ...
          <button
            onClick={scrollLeft}
            className="absolute left-0 top-1/2 -translate-y-1/2 bg-green-600 text-white p-3 rounded-full shadow-md opacity-60 hover:opacity-100 transition-opacity duration-300 z-10"
          ...
          >
            {departments.map((dept, index) => (
              <div
                key={index}
                className="w-[250px] flex-none bg-white rounded-xl shadow-md overflow-hidden border border-green-100 hover:border-green-500 transform hover:scale-105 transition-all duration-300"
              >
                <img
                  src={dept.image}
                  alt={dept.name}
          ...
          <button
            onClick={scrollRight}
            className="absolute right-0 top-1/2 -translate-y-1/2 bg-green-600 text-white p-3 rounded-full shadow-md opacity-60 hover:opacity-100 transition-opacity duration-300 z-10"
